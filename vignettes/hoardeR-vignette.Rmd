...
Packages from GitHub can be installed directly in R, using the _devtools_ package. To install the latest developer version of
...
![Similarity between Pig and Cow](/home/ejo138/GitHub/hoardeR/vignettes/pigFlanking.png)
...
```{r sendFastaExample, message=FALSE, warning=FALSE, include=FALSE}
...
```{r}
xmlNew <- importXML(folder="/home/ejo138/temp/hoardeR/", idTH=0.8)
tableSpecies(xmlNew)
...
for(i in 1:nrow(oaHits)){
  goatInter4.0[[i]] <- intersectXMLAnnot(oaHits[i,], oaannot4.0, flanking=20)
}
